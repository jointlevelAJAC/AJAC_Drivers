...
int main(int argc, char **argv) {
    ...
    while (true) {
        ...
        if (event->channel == "MOTOR DATA") {
            ...
            read_file_data_ << std::setw(12) << std::setfill(' ') << event->timestamp <<
                    std::setw(12) << std::setfill(' ') << msg.chip1_data[0] << " " <<
                    std::setw(12) << std::setfill(' ') << msg.chip1_data[1] << " " <<
                    std::setw(12) << std::setfill(' ') << msg.chip1_data[2] << " " <<
                    std::setw(12) << std::setfill(' ') << msg.chip1_data[3] << " " <<
                    std::setw(12) << std::setfill(' ') << msg.chip1_data[4] << " " << " \n";
            ...
            read_file_cmd_ << std::setw(12) << std::setfill(' ') << event->timestamp <<
                    std::setw(12) << std::setfill(' ') << msg_cmd.chip1_cmd[4] << " " <<
                    std::setw(12) << std::setfill(' ') << msg_cmd.chip1_cmd[9] << " " <<
                    std::setw(12) << std::setfill(' ') << msg_cmd.chip1_cmd[14] << " " <<
                    std::setw(12) << std::setfill(' ') << msg_cmd.chip2_cmd[4] << " " <<
                    std::setw(12) << std::setfill(' ') << msg_cmd.chip2_cmd[9] << " " <<
                    std::setw(12) << std::setfill(' ') << msg_cmd.chip2_cmd[14] << " " <<
                    std::setw(12) << std::setfill(' ') << msg_cmd.chip3_cmd[4] << " " << " \n";
        }
        // decode successful
    }
