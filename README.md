...
* *USB2FDCAN driver* supports 18 actuators working in the same time with amazing 4ms communication delays.
...
* *AJAC* provide real-time and low-load drivers communicating wieh USB2FDCAN, including the AJAC (the contract between kinematic reasoning and actuator realization).
